...
public class WarmupParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Warmup.g4"; }
	...
	public WarmupParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class LineContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(WarmupParser.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof WarmupListener ) ((WarmupListener)listener).enterLine(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof WarmupListener ) ((WarmupListener)listener).exitLine(this);
		}
	}
	...
	public static class Legal_exprContext extends ParserRuleContext {
		public TerminalNode LEFT_PAREN() { return getToken(WarmupParser.LEFT_PAREN, 0); }
		public TerminalNode RIGHT_PAREN() { return getToken(WarmupParser.RIGHT_PAREN, 0); }
		public List<Legal_exprContext> legal_expr() {
			return getRuleContexts(Legal_exprContext.class);
		}
		public Legal_exprContext legal_expr(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof WarmupListener ) ((WarmupListener)listener).enterLegal_expr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof WarmupListener ) ((WarmupListener)listener).exitLegal_expr(this);
		}
	}
